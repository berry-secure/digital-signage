...
export function summarizeDatabase(database: any): MigrationSummary {
  ...
  return {
    raw: {
      ...
      musicTracks: count(database.musicTracks),
      musicPlaylists: count(database.musicPlaylists),
      musicPlaylistTracks: count(database.musicPlaylistTracks),
      musicChannels: count(database.musicChannels),
    ...
    importable: {
      ...
      musicTracks: batches.musicTracks.length,
      musicPlaylists: batches.musicPlaylists.length,
      musicPlaylistTracks: batches.musicPlaylistTracks.length,
      musicChannels: batches.musicChannels.length,
